...
const mainFeatures = [
  ...
  },
  {
    ...
    description: "Один мощный сервер с отличной настройкой для быстрого и стабильного подключения.",
    icon: Globe,
    highlights: ["Мощный сервер", "99.9% аптайм", "Низкий пинг", "Оптимальная настройка"],
  },
  {
    title: "Максимальная скорость",
    description: "Наши серверы поддерживают скорости до 1 Гбит/с без ограничений трафика.",
    icon: Zap,
    highlights: ["До 1 Гбит/с", "Безлимитный трафик", "Без дросселирования", "Оптимизация скорости"],
  },
];
